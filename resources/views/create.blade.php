                        ...
                        @elseif(request()->routeIs('create.video'))
                            <div class="wrapper p-2">
                                @foreach ($videos as $video)
                                    <div class="item flex mb-5 gap-5 p-4 rounded-lg shadow-lg">
                                        <div class="media relative">
                                            <video class="w-20 h-20 rounded-lg object-cover" preload="metadata">
                                                <source src="{{ asset('storage/' . $video->filepath) }}">
                                            </video>
                                            <div class="mask absolute inset-0 rounded-lg bg-[#0005] grid place-content-center cursor-pointer">
                                                <svg class="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 18">
                        ...
                        @elseif(request()->routeIs('create.document'))
                            <div class="wrapper p-2">
                                @foreach ($documents as $document)
                                    <div class="item flex mb-5 gap-5 p-4 rounded-lg shadow-lg">
                                        <div class="media">
                                            <img class="w-20 h-20 rounded-lg" src="{{ asset('icons/file.png') }}" alt="document">
                                        </div>
                                        <div class="content">
