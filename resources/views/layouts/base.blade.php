    ...
    {{-- <nav class="bg-white border-gray-200 ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    class="font-medium flex flex-col p-4 md:p-0 md:items-center mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white ">
                    <li>
                        <x-nav-link href="#" active="true">Home</x-nav-link>
                    </li>
                    <li>
                        <x-nav-link href="#">Content</x-nav-link>
                    </li>
                    <li>
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <x-nav-link href="#">Creators</x-nav-link>
                        </li>
                        <li>
                            <x-nav-link href="#">Contents</x-nav-link>
                        </li>
                        <li>
                            <x-nav-link href="#">About</x-nav-link>
                        </li>
                    ...
                    <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                        <form class="w-full">
                            ...
                            <div class="border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                                ...
                                <button
                                    class="mt-1 w-full bg-primary-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-secondary-500 sm:mt-0 sm:w-auto sm:shrink-0">
                                    Sign Up
                                </button>
                            </div>
                        </form>
            ...
            <div class="mt-8 border-t border-gray-100 pt-8 ">
                <div class="sm:flex sm:justify-between">
                    <p class="text-xs text-gray-500 ">
                        &copy; {{ date('Y') }}. {{ config('app.name', 'Company Name') }}. All rights reserved.
                    </p>
